...
class GeoNetworkListener implements LocationListener {
	private static final String TAG = "GAP_" + GeoNetworkListener.class.getSimpleName();
	 ...
	 * @param m
	 */
	public GeoNetworkListener(Context context, int interval, GeoListener m) {
		this.owner = m;
