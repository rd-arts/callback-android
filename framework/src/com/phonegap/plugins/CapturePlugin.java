...
public class CapturePlugin extends Plugin {
	...
	private static final String TAG = "GAP_" + CapturePlugin.class.getSimpleName();
	...
	private JSONObject getFormatData(String filePath, String mimeType) {
		...
		try {
			...
			if (mimeType == null || mimeType.equals("")) {
				mimeType = FileUtilsPlugin.getMimeType(filePath);
			}
	...
	private void captureImage() {
		...
		File photo = new File(DirectoryManager.getTempDirectoryPath(this.context), "CaptureTmp.jpg");
	...
	public void onActivityResult(int requestCode, int resultCode, Intent intent) {
		...
		if (resultCode == Activity.RESULT_OK) {
			...
			if (requestCode == CAPTURE_AUDIO) {
				...
				// To work around it I had to grab the code from CameraLauncherPlugin.java
				try {
					// Create an ExifHelper to save the exif data that is lost during compression
					ExifHelper exif = new ExifHelper();
					exif.createInFile(DirectoryManager.getTempDirectoryPath(this.context) + "/CaptureTmp.jpg");
					exif.readExifData();
	...
	private JSONObject createMediaFile(Uri data) {
		File fp = new File(FileUtilsPlugin.getRealPathFromURI(context, data));
		JSONObject obj = new JSONObject();
