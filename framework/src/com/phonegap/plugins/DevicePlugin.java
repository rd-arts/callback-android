...
public class DevicePlugin extends Plugin {
	...
	public static final String PHONEGAP_VERSION = "1.1.0";
	/**
	 * Device OS.
	 */
	...
	public PluginResult execute(String action, JSONArray args, String callbackId) {
		...
		try {
			if (action.equals("getDeviceInfo")) {
				...
				r.put("platform", DevicePlugin.platform);
				r.put("name", this.getProductName());
				r.put("phonegap", DevicePlugin.PHONEGAP_VERSION);
				//JSONObject pg = new JSONObject();
				//pg.put("version", DevicePlugin.phonegapVersion);
				//r.put("phonegap", pg);
	...
	public String getPhonegapVersion() {
		return DevicePlugin.PHONEGAP_VERSION;
	}
