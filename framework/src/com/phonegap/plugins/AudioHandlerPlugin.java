 ...
 */
public class AudioHandlerPlugin extends Plugin {
	...
	public void setAudioOutputDevice(int output) {
		...
		if (output == 2) {
			...
			Log.d(TAG, "setAudioOutputDevice() Error: Unknown output device.");
		}
	}
	...
	private void setVolume(String id, float volume) {
		...
		if (audio != null) {
			...
			Log.d(TAG, "setVolume() Error: Unknown Audio Player " + id);
		}
	}
}
