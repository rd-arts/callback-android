...
//        this.pluginManager = new PluginManager(this, this.appView, this);
//
...
//
//        // If backgroundColor
//        this.backgroundColor = config.getIntegerProperty("backgroundColor", Color.BLACK, this);
//        this.root.setBackgroundColor(this.backgroundColor);
//
//        // If spashscreen
//        this.splashscreen = config.getIntegerProperty("splashscreen", 0, this);
//        if (this.firstPage && (this.splashscreen != 0)) {
//            root.setBackgroundResource(this.splashscreen);
//        }
//
//        // If loadInWebView
//        this.loadInWebView = config.getBooleanProperty("loadInWebView", false, this);
//
//        // If loadUrlTimeoutValue
//        int timeout = config.getIntegerProperty("loadUrlTimeoutValue", 0, this);
//        if (timeout > 0) {
//            this.loadUrlTimeoutValue = timeout;
//        }
//
//        // If keepRunning
//        this.keepRunning = config.getBooleanProperty("keepRunning", true, this);
//    }
//
//    /**
...
//                String loading = null;
//                if (me.firstPage) {
//                	loading = config.getStringProperty("loadingDialog", null, me);
//                }
//                else {
//                	loading = config.getStringProperty("loadingPageDialog", null, me);
//                }
//                if (loading != null) {
//
//                    String title = "";
...
//         * @param ctx
//         */
//        public GapWebViewClient(DroidGap ctx) {
//            this.ctx = ctx;
//        }
//
//        /**
...
//                if (this.ctx.loadInWebView || url.startsWith("file://") || this.ctx.baseUrl.equals(url) || isUrlWhiteListed(url)) {
//                    try {
...
//         final String errorUrl = config.getStringProperty("errorUrl", null, me);
